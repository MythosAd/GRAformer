...
import os
import torch
from GRAformer.exp.exp_main import Exp_Main
import random
import numpy as np
...
if __name__ == '__main__':
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}_mf{}_rs{}_3pe{}_pad{}_gau{}_rnnM{}_leb{}_rsq{}_ffn{}_2nm{}_norm{}_bias{}_gb{}_{}_{}_{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
                ...
                args.embed,
                args.distil,
                args.des,ii,args.mask_flag,args.res_attention,args.pe_3d,args.padding_patch,args.gau,
                args.rnn_matrix,args.LEB,args.reluSquared,args.ffn,args.resi_dual,args.norm,args.qkv_bias,args.gb,args.patch_len,args.stride,args.attention
                )
        ...
        ii = 0
        setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}_mf{}_rs{}_3pe{}_pad{}_gau{}_rnnM{}_leb{}_rsq{}_ffn{}_2nm{}_norm{}_bias{}_gb{}_{}_{}_{}'.format(args.model_id,
                                                                                                      args.model,
                                                                                                      args.data,
                                                                                                      args.features,
                                                                                                      args.seq_len,
                                                                                                      ...
                                                                                                      ii,args.mask_flag,
                                                                                                      args.res_attention,
                                                                                                      args.pe_3d,args.padding_patch,args.gau
                                                                                                      ,args.rnn_matrix
                                                                                                      ,args.LEB
                                                                                                      ,args.reluSquared,args.ffn,args.resi_dual
                                                                                                      ,args.norm,args.qkv_bias,args.gb,args.patch_len,args.stride,args.attention
                                                                                                      )
