...
if __name__ == '__main__':
    ...
    predictor = estimator.train(training_data = train_dataloader,validation_data = val_dataloader,num_workers=1)

    from gluonts.evaluation import make_evaluation_predictions
    forecast_it, ts_it = make_evaluation_predictions(dataset=val_dataloader,
                                                     predictor=predictor,
                                                     num_samples=100)
...
# agg_metrics, item_metrics = evaluator(iter(tss), iter(forecast_it), num_series=len(test_dataset))